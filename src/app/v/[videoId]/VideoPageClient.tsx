  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {/* Copy link section — single combined button (Transfr style) */}
        <div className="p-4">
          ...
          <button
            onClick={handleCopy}
            className={`w-full flex items-center rounded-xl border transition-all duration-300 overflow-hidden ${
              copied
                ? 'border-[#08CF65]/30 bg-[#E0F5EA]/50'
                : 'border-gray-200 bg-gray-50 hover:border-gray-300 hover:bg-gray-100'
            }`}
          >
            <span className="flex-1 text-left px-3.5 py-2.5 text-sm text-gray-600 font-mono truncate min-w-0">
              clips.drime.cloud/v/{videoId}
            </span>
            <span className={`flex items-center gap-1.5 px-4 py-2.5 text-sm font-medium border-l transition-all duration-300 flex-shrink-0 ${
              copied
                ? 'bg-[#E0F5EA] text-[#08CF65] border-[#08CF65]/20'
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          {/* Quick copy link badge (Transfr style — combined url + copy button) */}
          <button
            onClick={copyLink}
            className={`hidden sm:flex items-center rounded-xl border transition-all duration-300 overflow-hidden ${
              linkCopied
                ? 'border-[#08CF65]/30 bg-[#E0F5EA]/50'
                : 'border-gray-200 bg-gray-50 hover:border-gray-300'
            }`}
          >
            <span className="px-3 py-1.5 text-sm text-gray-500 font-mono truncate max-w-[200px]">
              clips.drime.cloud/v/{video.id.slice(0, 8)}
            </span>
            <span className={`flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium border-l flex-shrink-0 transition-all duration-300 ${
              linkCopied
                ? 'bg-[#E0F5EA] text-[#08CF65] border-[#08CF65]/20'
          ...
          <button
            onClick={copyLink}
            className={`sm:hidden flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-300 border ${
              linkCopied
